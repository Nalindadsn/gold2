...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen  transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-900 dark:border-gray-700" aria-label="Sidebar">
   <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-900">
      <ul className="space-y-2 font-medium">
         <li className="mt-3 border-b pb-2"><Link href="/" className="text-2xl font-bold m-2 pt-5" >Gold Loan</Link></li>
         <li>
...
<div className=" sm:ml-64">
   <div className=" border bg-white   mt-2">
