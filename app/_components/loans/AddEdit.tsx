            ...
            <div className="border shadow-sm mb-3">
              ...
              <div className="p-2 ml-1">
                ...
                <input
                  ...
                  value={
                    ( parseFloat(watchExpectedPriceOld) <= max_price) ? parseFloat(watchExpectedPriceOld).toFixed(2):max_price.toFixed(2)
                  }
