...
function Sidebar() {
  ...
  <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen  transition-transform -translate-x-full   border-gray-200 md:translate-x-0  bg-gray-800 text-blue-100" aria-label="Sidebar">
           <div className="h-full  pb-4 overflow-y-auto ">
            ...
            <path strokeLinecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
          </svg>
                 ...
                 <li  className="m-0">
                    <a href="/settings" className="flex items-center py-2 px-3 text-gray-200   hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-700 group">
                      ...
                      <path strokeLinecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path>
                    </svg>
                 ...
                 <li  className="m-0">
                    ...
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                            </svg>
